...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run(){
        String [] text = new String[] {"Taj Hotel","Raj Mahal","Radison Blue","The Bay Club",
        "Breeze Blow Hotel","River view Hotel", "Snow Point Hotel","Maharajah Hotel","Sheridan Hotel","Kingsview Hotel"};
        try{
            for(int i =0;i<=9;i++){
